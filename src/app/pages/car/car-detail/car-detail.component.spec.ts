...
describe('CarDetail', () => {
    ...
    beforeEach(() => {
        ...
        carService = jasmine.createSpyObj('CarServiceService', ['deleteCar']);
        ...
        component = TestBed.createComponent(CarDetailComponent).componentInstance;
        ...
        carService.deleteCar.and.returnValue(of(expectedCar));
    });
